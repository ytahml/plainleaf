...
- `kepano/flexoki` — MIT License, copyright Steph Ango. Plainleaf adapts its screen-oriented prose and code palette for the app chrome and local syntax-highlighting styles. The upstream license is retained in `Vendor/Flexoki/LICENSE`.
